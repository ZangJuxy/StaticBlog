...
swiperImg: 'https://zangzang.oss-cn-beijing.aliyuncs.com/img/wallhaven-k7mww1.jpg' # 该文章在轮播图中的图片，可以是本地目录下图片也可以是http://xxx图片
img: 'https://zangzang.oss-cn-beijing.aliyuncs.com/img/wallhaven-k7mww1.jpg' # 该文章图片，可以是本地目录下图片也可以是http://xxx图片
categories: 设计模式 # 分类
tags: ['模板模式','策略模式'] #标签
top: true
