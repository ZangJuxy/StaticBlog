...
swiperImg: 'https://zangzang.oss-cn-beijing.aliyuncs.com/picGo/wallhaven-we8dv7.jpg' # 该文章在轮播图中的图片，可以是本地目录下图片也可以是http://xxx图片
img: 'https://zangzang.oss-cn-beijing.aliyuncs.com/picGo/wallhaven-we8dv7.jpg' # 该文章图片，可以是本地目录下图片也可以是http://xxx图片
categories: 技巧 # 分类
